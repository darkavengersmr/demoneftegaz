...
const WorkPermitOGRequestPage: React.FC = () => {
      ...
      <Header />
        ...
        { tab === "issue" && 
          <WorkPermitIssueRequest user={user.data}
                                  ...
                                  title="Журнал регистрации нарядов-допусков на проведение огневых работ"
          />
        }
        { tab === "receive" && 
          <WorkPermitReceiveRequest workPermitsList={workPermit.getNotCompletedInJournal("Журнал регистрации нарядов-допусков на проведение огневых работ")}   
                                    workPermitReceive={workPermit.workPermitReceive.bind(workPermit)}
                                    title="Журнал регистрации нарядов-допусков на проведение газоопасных работ"
                                    personById={persons.getById.bind(persons)}
          />
        }
        { tab === "registry" &&
          <WorkPermitRegistryForm  workPermitRegistry={workPermit.getByJournal("Журнал регистрации нарядов-допусков на проведение огневых работ")}
                                   personById={persons.getById.bind(persons)}                                   
                                   title="Журнал регистрации нарядов-допусков на проведение огневых работ"
          />
        }
...
export default observer(WorkPermitOGRequestPage);